  ...
  return (
    <div>
      ...
      <section className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 md:py-16 md:px-12">
        <a
          href="https://github.com/tsu-ki/PrepPal.AI"
        ...
        <div className="border rounded-lg bg-gray-100 p-4 max-w-4xl w-full mx-auto">
          <section className="py-8 px-4 text-center lg:py-16 lg:px-12">
            <h2 className="font-extrabold text-2xl md:text-3xl lg:text-5xl">
              What Users have experienced after using PrepPal.AI
            </h2>
            <div className="mt-8 flex flex-col lg:flex-row gap-4 justify-center">
              <div className="flex flex-col items-center">
                <h3 className="text-sm text-gray-400">Without PrepPal.AI</h3>
              ...
              <div className="flex flex-col items-center">
                <h3 className="text-sm text-gray-400">With PrepPal.AI</h3>
                <ul className="mt-4 text-lg font-normal text-gray-500">
                  <li className="mb-4">
