...
<section class="bg-white">
  ...
  <div class="hidden lg:relative lg:block lg:p-12 bg-blue-900 bg-opacity-80">
    ...
    <h2 class="mt-6 text-3xl font-bold text-white sm:text-3xl md:text-4xl">
      Discover AI Interviews with <strong>PrepPal.AI</strong> 🤖
    </h2>
...
<svg width="200" height="150" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="100" y="30" text-anchor="middle" fill="white" font-family="modesto" font-size="18" font-weight="bold">PrepPal</text>
